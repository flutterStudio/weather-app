import 'package:weather_app/common/settings.dart' as app_settings;
...
class Data<T> {
  ...
  app_settings.ErrorType _errorType = app_settings.ErrorType.none;
  Data({
    required T data,
  ...
  Data.faild(
      {T? previousData,
      required String message,
      app_settings.ErrorType errorType = app_settings.ErrorType.other})
  ...
  app_settings.ErrorType get errorType => _errorType;
}
